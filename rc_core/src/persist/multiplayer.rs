...
pub(super) fn default_net_conf() -> NetworkConf {
    NetworkConf {
        ...
        resend_delay_base: 0.05,
        resend_delay_rtt_mult: 1.5,
...
pub(super) fn default_filler_users() -> Vec<FakePlayerConf> {
    vec![
        FakePlayerConf {
            ...
            vehicle: super::garage::PrefabVehicle {
                name: Some("fake1".to_owned()),
                username: "ServerFiller1".to_owned(),
                id: super::garage::PrefabId::Raw {
                    cube_data: Vec::from(crate::persist::VALID_ROBOT),
                    colour_data: Vec::from(crate::persist::VALID_COLOUR),
                },
        ...
        FakePlayerConf {
            ...
            vehicle: super::garage::PrefabVehicle {
                name: Some("fake2".to_owned()),
                username: "ServerFiller2".to_owned(),
                id: super::garage::PrefabId::Raw {
                    cube_data: Vec::from(crate::persist::VALID_ROBOT),
                    colour_data: Vec::from(crate::persist::VALID_COLOUR),
                },
        ...
        FakePlayerConf {
            ...
            vehicle: super::garage::PrefabVehicle {
                name: Some("fake3".to_owned()),
                username: "ServerFiller3".to_owned(),
                id: super::garage::PrefabId::Raw {
                    cube_data: Vec::from(crate::persist::VALID_ROBOT),
                    colour_data: Vec::from(crate::persist::VALID_COLOUR),
                },
        ...
        FakePlayerConf {
            ...
            vehicle: super::garage::PrefabVehicle {
                name: Some("fake4".to_owned()),
                username: "ServerFiller4".to_owned(),
                id: super::garage::PrefabId::Raw {
                    cube_data: Vec::from(crate::persist::VALID_ROBOT),
                    colour_data: Vec::from(crate::persist::VALID_COLOUR),
                },
...
fn default_ba_base() -> super::garage::PrefabVehicle {
    ...
    crate::cubes::OffsetParser.offset_inplace_with_id(&mut cube_data, (0, 10, 0), 3950293873);
    super::garage::PrefabVehicle {
