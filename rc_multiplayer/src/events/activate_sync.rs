...
pub(super) fn handler(init_ctx: &crate::InitConfig) -> crate::handlers::Dataless<RequestLoadingSync> {
    crate::handlers::Dataless::new(RequestLoadingSync::new(init_ctx))
}
...
impl crate::handlers::DatalessEventCodeHandler for RequestLoadingSync {
